...
#pragma mark - 返回联系人
+(NSMutableArray*)LetterSortArray:(NSMutableArray*)stringArr
{
    NSMutableArray *tempArray = [self ReturnSortChineseArrar:stringArr];
...
//
///////////////////
+(NSMutableArray*)ReturnSortChineseArrar:(NSMutableArray*)stringArr
{
...
+(NSMutableArray*)SortArray:(NSMutableArray*)stringArr
{
    NSMutableArray *tempArray = [self ReturnSortChineseArrar:stringArr];
